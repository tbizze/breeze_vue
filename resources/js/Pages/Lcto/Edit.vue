...
const form = useForm({
  lcto_data: props.lancamento.lcto_data,
  lcto_historico: props.lancamento.lcto_historico,
  lcto_tipo: props.lancamento.lcto_tipo,
  lcto_valor: props.lancamento.lcto_valor,
  lcto_notas: props.lancamento.lcto_notas,
  lcto_grupo_id: props.lancamento.lcto_grupo_id,
 ...
 */
function submit() {
  form.put(route("lcto.update",props.lancamento.id));
}
